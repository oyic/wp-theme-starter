...
export const watch = () => {
  ...
  gulp.watch("src/assets/js/**/*.js", gulp.series(scripts, reloadServer));
  gulp.watch("**/*.php", reloadServer);
  gulp.watch(paths.images.src, gulp.series(images, reloadServer));
  gulp.watch(paths.others.src, gulp.series(copy, reloadServer));
};
