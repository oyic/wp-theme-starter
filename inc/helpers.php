...
function _placeholder_post_meta() {
    /* tanslators: %s: Post Date */
    printf(
        esc_html__( 'Posted on %s', '_placeholder' ),
...
function _placeholder_readmore_link() {
    echo '<a href="' . esc_url(get_the_permalink()) . '" title="' . the_title_attribute(['echo' => false]) . 
    '">';
    /* tanslators: %s: Post Title */
    printf(
        wp_kses(
            __(' Read More <span class="u-screen-reader-text">About %s</span> ', '_placeholder'), 
            [
                'span' => [
                    'class' => []
                ]
